...
<html>
  <head>
    ...
    <title>AsignacionDeTribunales</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Tribunales</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/profesionales/registrar"><i class="fa fa-circle-o"></i> Registrar profesional</a></li>
                <li><a href="/profesionales/registrarlote"><i class="fa fa-circle-o"></i> Registrar por lote</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="ventas/venta"><i class="fa fa-circle-o"></i> Registrar Invitado</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>Tribunales</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="www.incanatoit.com">Hashtag Co.</a>.</strong> All rights reserved.
      </footer>
